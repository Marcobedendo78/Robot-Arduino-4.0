...
void Read_X_Y_Values() {
  ...
  // Recupera i valori scalati dal magnetometro (ridimensionati sulla scala configurata).
...
void Test_Compass_Check_Tip_Angle() {
  ...
  // Legge l'angolo della bussola e lo calcola in base alla calibrazione effettuata.
