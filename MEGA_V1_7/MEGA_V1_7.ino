...
*******************************************************************************************************************************************/
  ...
  int PWM_Compass_Speed_LH         = 130;                        // Velocità del tosaerba durante la ricerca della direzione per tovare il filo ruota SX.
  int PWM_Compass_Speed_RH         = 130;                        // Velocità del tosaerba durante la ricerca della direzione per tovare il filo ruota DX.
  ...
  float Max_Wheel_Amps             = 2.2;                        // Amperaggio massimo consentito nelle ruote prima che venga chiamato un blocco.
  ...
  */
  ...
  // Valori di rilevamento filo
    ...
    float P               = 1.04;     //EEPROM                     // Fattore di moltiplicazione per l'errore misurato al centro del filo. Se il movimento è a scatti durante il monitoraggio riduce il numero
                                                                   // Valore per la tracciatura del filo perimetrale in uscita dalla base
    float P_Return        = 1.12;     //EEPROM                     // Fattore di moltiplicazione per l'errore misurato al centro del filo. Se il movimento è a scatti durante il monitoraggio riduce il numero
