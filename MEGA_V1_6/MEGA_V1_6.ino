...
*******************************************************************************************************************************************/
  ...
  int PWM_Max_Slow_Speed_LH        = 140;                        // Velocità del tosaerba durante la rotazione sul filo ruota SX
  int PWM_Max_Slow_Speed_RH        = 140;                        // Velocità del tosaerba durante la rotazione sul filo ruota DX
  int PWM_Max_Slow_Speed_2_LH      = 120;                        // Velocità del tosaerba durante la ricerca del filo ruota SX
  int PWM_Max_Slow_Speed_2_RH      = 120;                        // Velocità del tosaerba durante la ricerca del filo ruota DX
  ...
  */
  ...
  // Valori di rilevamento filo
    ...
    float P               = 1.12;     //EEPROM                     // Fattore di moltiplicazione per l'errore misurato al centro del filo. Se il movimento è a scatti durante il monitoraggio riduce il numero
